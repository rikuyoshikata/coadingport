...
<head>
	...
	<meta name="description" content="RadioStrikeの最新情報です。今後の予定とかをお伝えしていきます。">
...
<head prefix="og: http://ogp.me/ns#">
	...
	<meta name="og:description" content="RadioStrikeの最新情報です。今後の予定とかをお伝えしていきます。">
		...
		<div id="app">
			<v-app>
				...
				<v-app-bar>
					...
					<div class="container">
					<?php include('wp/wp_info_content.inc'); ?>
				</div>
				<v-footer>
					<!--フッター内容-->
